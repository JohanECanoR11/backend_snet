...
export const updateUser = async (req, res) => {
  try {
    ...
    // Verificar si el usuario está duplicado y evitar conflictoe
    const isDuplicateUser = users.some(user => {
      return user && user._id.toString() !== userIdentify.userId;
    });
    ...
    // Buscar y actualizar
    let userUpdated = await User.findByIdAndUpdate(userIdentify.userId, userToUpdate, { new: true });
